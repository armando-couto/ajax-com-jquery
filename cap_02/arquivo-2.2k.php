...
<div id="tudo">
<div id="conteudo">
<h1>Exemplo de requisição com uso da funçãoo $.ajax( )</h1>
<fieldset>
...
<div id="nav">Arquivos exemplo do livro do Maujor | AJAX com jQuery: <a href="arquivo-2.2j.php">&laquo; anterior</a> | <a href="arquivo-2.2l.php">próximo &raquo;</a></div>
