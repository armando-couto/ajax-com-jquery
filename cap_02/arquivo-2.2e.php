...
$(document).ready(function() {
	...
	$.getScript('http://www.clickmaujor.com/jquery.corner.js', function() {
	$(iconCarregando).hide();
...
<h1>Exemplo de requisição com uso da função $.getScript( )</h1>
...
<p>Logo após o carregamento da página clique nos retângulos e observe que nada acontece.<br />
 A seguir faça a requisição AJAX clicando o botão abaixo e após o carregamento do plugin clique novamente nos retângulos.</p>
...
<div id="nav">Arquivos exemplo do livro do Maujor | AJAX com jQuery: <a href="arquivo-2.2d.php">&laquo; anterior</a> | <a href="arquivo-2.2f.php">próximo &raquo;</a></div>
