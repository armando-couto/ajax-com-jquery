...
$(document).ready(function(){
	...
	$.get('exemplo-ajaxcomplete.html', {nome: 'maujor'}, 
	function(data) {
...
<small class="destaque">Requisição bem sucedida</small></h1>
<a href="exemplo-ajaxcomplete.html" id="carrega">Requisitar o arquivo exemplo-ajaxcomplete.html</a>
...
<div id="nav">Arquivos exemplo do livro do Maujor | AJAX com jQuery: <a href="arquivo-3.2e.php">&laquo; anterior</a> | <a href="arquivo-3.2g.php">próximo &raquo;</a></div>
