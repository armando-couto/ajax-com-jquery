...
$(document).ready(function(){
	...
	e.preventDefault();
		$('#mensagem').ajaxSuccess(function(event, xhr, settings) {
		$(this).append('<p class="destaque">A requisição AJAX foi um sucesso. Resultado: ' + xhr.status + ' - ' + xhr.statusText +  '</p>');
		var inspecionar = ''; 
...
<div id="tudo">
<div id="conteudo">
<h1>Exemplo de requisição com uso dos parâmetros do método<br />ajaxSuccess(event, xhr, settings)</h1>
<a href="exemplo-ajaxsuccess.html" id="carrega">Requisitar o arquivo exemplo-ajaxsuccess.html</a>
...
<div id="nav">Arquivos exemplo do livro do Maujor | AJAX com jQuery: <a href="arquivo-3.2d.php">&laquo; anterior</a> | <a href="arquivo-3.2f.php">próximo &raquo;</a></div>
